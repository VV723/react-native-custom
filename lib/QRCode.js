  ...
  //Returns an array of SVG Elements that represent the pieces of the QR Code
   ...
   displayLogo(){
     if(this.props.logo){
       return(
          <View style={{
            width: this.props.logoSize + this.props.logoMargin, 
            height: this.props.logoSize + this.props.logoMargin, 
            position: 'absolute', 
            left: ((this.props.size/2)-(this.props.logoSize/2 + this.props.logoMargin/2)), 
            top: ((this.props.size/2)-(this.props.logoSize/2 + this.props.logoMargin/2)),
            backgroundColor: '#FFFFFF',
            alignItems: 'center',
            justifyContent: 'center',
            borderRadius: this.props.logoBorderRadius
